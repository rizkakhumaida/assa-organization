  ...
  @auth
    ...
    @if(auth()->user()->role === 'anggota')
      ...
      <a href="{{ route('anggota.scholarship.index') }}" class="{{ request()->routeIs('anggota.scholarship.*') ? 'active' : '' }}">
        <i class="bi bi-mortarboard"></i> <span>Apply Beasiswa</span>
      </a>
      <a href="{{ route('anggota.partnerships.index') }}" class="{{ request()->routeIs('anggota.partnerships.index') ? 'active' : '' }}">
        <i class="bi bi-people"></i> <span>Pengajuan Kerjasama</span>
      </a>
      <a href="{{ route('anggota.achievements.index') }}" class="{{ request()->routeIs('anggota.achievements.index') ? 'active' : '' }}">
        <i class="bi bi-trophy"></i> <span>Penyetoran Prestasi</span>
      </a>
    @endif
    ...
    <form id="logout-form-universal" action="{{ route('logout') }}" method="POST" class="d-none">@csrf</form>
  @endauth
</div>
